...
### 8.4 Sense naming bridge — sense_id to True Name to tool prefix (v0.6.2)

All four live senses follow the same wire pattern: the `sense` field in `sense.tool_call`
