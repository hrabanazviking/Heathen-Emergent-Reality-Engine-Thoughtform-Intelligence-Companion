...
| **Library** | Mímisbrunnr | Optional offline knowledge wells — Wikipedia, Gutenberg, sagas, custom corpora — searchable by the spirit |
...
- ✅ Equipped with an optional offline library (Mímisbrunnr) — the spirit can drink from the well of wisdom when desired
...
> **Editor's note (2026-05-07):** This document is the canonical vision for H.E.R.E.T.I.C. It supersedes earlier framings in `README.md`, `PHILOSOPHY.md`, `proposed_system_report/`, and `heretic_v2_implementation_pack/` where they conflict. Those earlier documents remain in the repo as the historical record of how the vision arrived here, but the architecture, scope, and roadmap drawn from this manifesto are authoritative going forward.
